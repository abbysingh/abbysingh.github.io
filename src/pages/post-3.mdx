...
<div className = "blog-content-image-container">
	<img src={_frontmatter.images[2].publicURL} className="blog-content-image" style="border-radius:16px" />
</div>
<p className = "image-caption">A quick before/after</p>

<div className = "blog-content-image-container">
	<img src={_frontmatter.images[3].publicURL} className="blog-content-image" style="border-radius:16px" />
</div>
