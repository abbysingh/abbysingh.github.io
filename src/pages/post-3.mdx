...
<img src="https://res.cloudinary.com/dzrqeyspq/image/upload/v1621782212/omio-before_ileci3.png" className="blog-content-image" />
</div>
...
<div className = "blog-content-image-container">
<img src="https://res.cloudinary.com/dzrqeyspq/image/upload/v1621782416/omio-2_rgxga5.png" className="blog-content-image" />
</div>
...
<div className = "blog-content-image-container">
<img src="https://res.cloudinary.com/dzrqeyspq/image/upload/v1621782214/omio-beforeafter_tppsgw.gif" className="blog-content-image" style="border-radius:16px" />
</div>
<p className = "image-caption">A quick before/after</p>

<div className = "blog-content-image-container">
<img src="https://res.cloudinary.com/dzrqeyspq/image/upload/v1621782214/omio-4_qaqwqo.png" className="blog-content-image" style="border-radius:16px" />
</div>
<p className = "image-caption">A solution that scaled across all of our platforms</p>
...
#### Impact 🍪
After shipping the new search result page and the round-trip interactions, we had an ⬆️**8%** increase in round-trip bookings and a ⬆️**5%** increase in overall bookings!
